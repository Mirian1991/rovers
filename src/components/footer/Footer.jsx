    ...
    <div className="footer-container">
      <div className="footer-flex">
        <div className="footer-first">
          <ul>
            <li className="footer-first-flex">
              {" "}
              <img
                src={aboutusicon}
                alt="aboutus"
            ...
            <li className="footer-first-flex">
              ...
              <img
                ...
                height="15px"
              />{" "}
              <a href="/Question"> Frequently Asked Questions </a>{" "}
            </li>
            <li className="footer-first-flex">
              {" "}
              <img
            ...
            <li className="footer-first-flex">
              ...
              <img
                ...
                height="20px"
              />
              <a href="/Delivery"> Purchase/Delivery </a>{" "}
            </li>
            <li className="footer-first-flex">
              {" "}
              <img src={helpicon} alt="help" width="20px" height="20px" />{" "}
              <a href="/Help"> Help </a>{" "}
            </li>
            <li className="footer-first-flex">
              {" "}
          ...
          <a
            ...
            href="https://www.facebook.com/RoversSneakers/"
            target="_blank"
          >
